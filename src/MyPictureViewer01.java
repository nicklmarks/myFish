...
public class MyPictureViewer01
{
   public static void main(String[] args)
   {
      ...
      frame.setSize(800,500); // @@@ MODIFY THIS LINE IF YOU LIKE
      
      // Set your own title
      frame.setTitle("Nicholas First Fish(StickFigure) Drawing"); // @@@ MODIFY THIS LINE
      ...
      MyPictureComponent01 component = new MyPictureComponent01();
